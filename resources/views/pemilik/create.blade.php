            ...
            <div class="identity-card">
                <form action="{{ route('pemilik.profile.identitas.store') }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="form-grid">
                            ...
                            <div class="form-group form-group-full">
                                ...
                                <small class="upload-hint">
                                    Foto profil berformat JPG/JPEG/PNG dan maksimal 1 MB.
                                </small>
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-grid">
                            <div class="form-group">
                                <label for="nama_usaha">Nama Usaha / Nama Kos</label>
                            ...
                            <div class="form-group">
                                <label for="status_pengelola">Status Pengelola</label>
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-grid">
                            <div class="form-group form-group-full">
                                ...
                                <small class="upload-hint">
                                    File JPG/JPEG/PNG, maksimal 2 MB.
                                </small>
                            ...
                            <div class="form-group form-group-full">
                                <label for="foto_selfie">Foto Selfie dengan KTP</label>

                                <input type="file" id="foto_selfie" name="foto_selfie" accept=".jpg,.jpeg,.png"
                                    class="file-input-hidden">

                                <label for="foto_selfie" class="upload-box">
                                    <div class="upload-box-left">
                                        <div class="upload-icon">
                                            <i class="fa-solid fa-camera"></i>
                                        </div>
                                        <div class="upload-text">
                                            <strong id="selfie-file-name">
                                                {{ !empty($identitas?->foto_selfie) ? 'Ganti foto selfie' : 'Pilih foto selfie + KTP' }}
                                            </strong>
                                            <span>Upload selfie sambil memegang KTP</span>
                                        </div>
                                    </div>
                                    <div class="upload-action">
                                        Pilih File
                                ...
                                @if (!empty($identitas?->foto_selfie))
                                    <div class="avatar-preview-wrap">
                                        <img src="{{ asset('storage/' . $identitas->foto_selfie) }}" alt="Foto Selfie"
                                            class="avatar-preview">
                                    </div>
                                @endif
                            </div>

    ...
    <section class="identity-detail-section">
        <div class="container">
            ...
            <div class="identity-page-header">
                <div>
                    <h1>Detail Identitas Mahasiswa</h1>
            ...
            <div
                ...
                <div class="verification-info-text">
                    @if ($status === 'approved')
                        ...
                        <p>Semua fitur RoomKos sudah dapat Anda akses.</p>
                    @elseif($status === 'rejected')
                        <h3>Status identitas Anda ditolak</h3>
                        <p>Silakan periksa data Anda dan lakukan perbaikan agar dapat diverifikasi kembali.</p>
                    @else
                        <h3>Status identitas Anda masih menunggu verifikasi</h3>
                        <p>Tunggu hingga status menjadi <strong>approved</strong> agar semua fitur seperti booking dan
                            transaksi dapat diakses.</p>
                    @endif
                </div>
            </div>
            ...
            <div class="identity-detail-grid">
                <div class="identity-profile-card">
                    ...
                    <div class="profile-main-info">
                        ...
                        <p>{{ $identitas->universitas->nama_universitas ?? '-' }}</p>
                ...
                <div class="identity-data-card">
                    ...
                    <div class="detail-list">
                        ...
                        <div class="detail-item">
                            ...
                            <strong>{{ $identitas->asal_kota }}</strong>
                        </div>
                    </div>
                </div>
                ...
                <div class="identity-data-card">
                    ...
                    <div class="detail-list">
                        <div class="detail-item">
                            ...
                            <strong>{{ $identitas->universitas->nama_universitas ?? '-' }}</strong>
                        </div>

                        <div class="detail-item">
                            <span class="detail-label">Semester</span>
                            <strong>Semester {{ $identitas->semester }}</strong>
                        </div>
                    </div>
                </div>
